# This Makefile is for the RemoveWorldWritable extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Folders/RemoveWorldWritable.pm]
#     AUTHOR => q[Ben Brandt <@BBrandtTX>]
#     BUILD_REQUIRES => {  }
#     NAME => q[RemoveWorldWritable]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Folders/RemoveWorldWritable.pm]
...
DIRFILESEP = \\
DFSEP = $(DIRFILESEP)
NAME = RemoveWorldWritable
NAME_SYM = RemoveWorldWritable
VERSION = 1.00
...
MAKE = dmake
FULLEXT = RemoveWorldWritable
BASEEXT = RemoveWorldWritable
PARENT_NAME = 
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Folders/RemoveWorldWritable.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
TO_INST_PM = file-permissions.pl \
	lib/Folders/Iterate.pm \
	lib/Folders/RemoveWorldWritable.pm

PM_TO_BLIB = lib/Folders/RemoveWorldWritable.pm \
	blib\lib\Folders\RemoveWorldWritable.pm \
	lib/Folders/Iterate.pm \
	blib\lib\Folders\Iterate.pm \
	file-permissions.pl \
	$(INST_LIB)\file-permissions.pl
...
DISTNAME = RemoveWorldWritable
DISTVNAME = RemoveWorldWritable-1.00
...
RemoveWorldWritable.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"RemoveWorldWritable\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "name:               RemoveWorldWritable" >> META_new.yml
	$(NOECHO) $(ECHO) "version:            1.00" >> META_new.yml
	$(NOECHO) $(ECHO) "abstract:           ~" >> META_new.yml
	$(NOECHO) $(ECHO) "author:" >> META_new.yml
	$(NOECHO) $(ECHO) "    - Ben Brandt <@BBrandtTX>" >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) "    <AUTHOR>Ben Brandt &lt;@BBrandtTX&gt;</AUTHOR>" >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({{@ARGV}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/Folders/RemoveWorldWritable.pm blib\lib\Folders\RemoveWorldWritable.pm \
	  lib/Folders/Iterate.pm blib\lib\Folders\Iterate.pm \
	  file-permissions.pl $(INST_LIB)\file-permissions.pl 
